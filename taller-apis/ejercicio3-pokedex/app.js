...
// Endpoint: /pokemon/{name or id} :contentReference[oaicite:7]{index=7}
...
/**
 * Extra para “promesas”: traer detalles de habilidades en paralelo con Promise.all
 * (solo 2 para no hacer mil requests)
 */
...
function renderPokemonCard(poke, abilityDetails = []) {
  ...
  // Resumen de efectos (si llegaron detalles)
