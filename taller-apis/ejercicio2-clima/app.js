...
// 1) Pega tu API KEY aquí (OpenWeather)
// IMPORTANT: en proyectos reales NO se expone la key en frontend.
...
// Geocoding API: city -> lat/lon :contentReference[oaicite:4]{index=4}
async function getCoordsByCity(city) {
  ...
  return results[0]; // { name, lat, lon, country, state? }
}

// Current Weather: lat/lon :contentReference[oaicite:5]{index=5}
